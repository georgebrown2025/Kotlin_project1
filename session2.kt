...
class Car {
    ...
    constructor(lp:String, c:String, p:Double) {
    ...
    constructor(lp:String, p:Double) {
...
fun main() {
    ...
    val c1: Car = Car("HND101", "black", 1000.0)
    println("car created!")
    ...
    val c2: Car = Car("CIV999", "orange", 1000.0 * 1.25)
    ...
    val c3: Car = Car("HC131", "blue", 1000.0 - 125)
    println(c3.model)
